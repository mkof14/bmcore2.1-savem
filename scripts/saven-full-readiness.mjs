...
const steps = [
  ...
  { label: 'Post-launch incident drill', command: 'npm', args: ['run', 'incident-drill:saven'] },
  { label: 'Rollback proof package', command: 'npm', args: ['run', 'rollback-proof:saven'] },
  { label: 'Operator evidence package', command: 'npm', args: ['run', 'operator-evidence:saven'] },
  { label: 'Live watch checklist', command: 'npm', args: ['run', 'live-watch:saven'] },
  { label: 'Operator sign-off', command: 'npm', args: ['run', 'signoff:saven'] },
  { label: 'Final seal package', command: 'npm', args: ['run', 'final-seal:saven'] },
  { label: 'Clean release pass', command: 'npm', args: ['run', 'clean-release:saven'] },
  { label: 'Production GO handoff', command: 'npm', args: ['run', 'go-handoff:saven'] },
  { label: 'Production GO decision', command: 'npm', args: ['run', 'production-go:saven'] },
  { label: 'Production values ready', command: 'npm', args: ['run', 'values-ready:saven'] },
  { label: 'Release lock', command: 'npm', args: ['run', 'release-lock:saven'] },
  { label: 'Strict GO package', command: 'npm', args: ['run', 'strict-go:saven'] },
  ...
  { label: 'Production values gap report', command: 'npm', args: ['run', 'values-gap:saven'] },
